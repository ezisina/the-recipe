...
const customcolor1 = Color(0xFF173156);


CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF173156),
  customcolor1: Color(0xFF275EA7),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFD6E3FF),
  onCustomcolor1Container: Color(0xFF001B3D),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFF173156),
  customcolor1: Color(0xFFA9C7FF),
  onCustomcolor1: Color(0xFF003062),
  customcolor1Container: Color(0xFF00468B),
